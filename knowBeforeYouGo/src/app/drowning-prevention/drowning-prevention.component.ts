...
// quizzler service injection:
  ...
  updaetImages() {
    ...
    if (this.imgTracker === this.imgArr[0]) {
      this.rend.setStyle(this.elemRef.nativeElement, 'backgroundImage', 'url(./../assets/DrowningStatistics.png');
      ...
      this.rend.setStyle(this.elemRef.nativeElement, 'backgroundImage', 'url(./../assets/childrenIncreased.png)');
      this.validator = false;
      ...
      this.rend.setStyle(this.elemRef.nativeElement, 'backgroundImage', 'url(./../assets/poolSafteyTips.png)');
      this.validator = false;
      this.validator1 = false;
      this.validator2 = false;
      ...
      this.rend.setStyle(this.elemRef.nativeElement, 'backgroundImage', 'url(./../assets/preparToSwim.png)');
      this.validator = false;
      this.validator1 = false;
      this.validator2 = false;
      this.validator3 = false;
      ...
      this.rend.setStyle(this.elemRef.nativeElement, 'backgroundImage', 'url(./../assets/Whenyourpoolisbeingused.png)');
      this.validator = false;
      this.validator1 = false;
      this.validator2 = false;
      this.validator3 = false;
      ...
      this.rend.setStyle(this.elemRef.nativeElement, 'backgroundImage', 'url(./../assets/Whenyourpoolisnotinuse.png)');
      this.validator = false;
      this.validator1 = false;
      this.validator2 = false;
      this.validator3 = false;
